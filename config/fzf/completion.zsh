...
if ! declare -f _fzf_compgen_path > /dev/null; then
  _fzf_compgen_path() {
    ...
    # rg --files --hidden --follow --glob "!.git/*" --glob "!*/.git/*" --glob "!*.git" -- . "$1"
    ag --hidden -g "" --ignore-dir ".git" 2> /dev/null
...
if ! declare -f _fzf_compgen_dir > /dev/null; then
  _fzf_compgen_dir() {
    ...
    # rg --files --hidden --follow --glob "!.git/*" --glob "!*/.git/*" --glob "!*.git" -g '*/' -- . "$1" | xargs -I{} dirname "{}" | sort -u
